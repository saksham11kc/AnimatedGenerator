package com.saksham.animatedArtGenerator.controller;

import com.saksham.animatedArtGenerator.dto.TextGenerationRequestDTO;
import com.saksham.animatedArtGenerator.service.GhibliArtService;
...
public class GenerationController {
    ...
    @PostMapping(value = "/generate-from-text" , produces = MediaType.TEXT_PLAIN_VALUE )
